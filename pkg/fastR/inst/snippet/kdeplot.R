...
kdePlot1 <- kdeplot(x,K1,xlim=c(1,11),ylim=c(0,0.32),n=500,
    main=expression(K[1]))
kdePlot2 <- kdeplot(x,K2,xlim=c(1,11),ylim=c(0,0.32),n=500,
    main=expression(K[2]))
kdePlot3 <- kdeplot(x,K3,xlim=c(1,11),ylim=c(0,0.32),n=500,
    main=expression(K[3]))
kdePlot4 <- kdeplot(x,K4,xlim=c(1,11),ylim=c(0,0.32),n=500,
    main=expression(K[4]))
